...
namespace KoalaRunBot {
  class InformationManager {
    ...
    std::map<BWAPI::Player, UnitStatistic> _unitData;
    ...
    bool IsCloseEnough(BWAPI::TilePosition a, BWAPI::TilePosition b) const;
  ...
  public:
    ...
    const UnitStatistic& getUnitData(BWAPI::Player player) const;
